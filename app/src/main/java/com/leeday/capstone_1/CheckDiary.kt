...
class CheckDiary : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val backgrounds = arrayOf(R.drawable.diary1, R.drawable.diary2, R.drawable.diary3, R.drawable.diary4,
                R.drawable.diary7, R.drawable.diary8, R.drawable.diary9, R.drawable.diary11, R.drawable.diary12, R.drawable.diary13) // 원하는 배경 리소스를 추가하십시오
